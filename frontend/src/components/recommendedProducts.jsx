    ...
    const fetchRecommendations = async () => {
      ...
      try {
        ...
        if (currentUser?.id) {
          ...
          const ranked = rankAnonymousProducts(
            activityResponse.data.products || []
          ).slice(0, 10);
  ...
  return (
    <section className="recommendations-section">
      <div className="recommendations-header">
        <div>
          <p className="recommendations-eyebrow">AI Selected</p>
      ...
      <div className="recommendations-grid">
        {error ? (
          <p className="recommendations-empty">{error}</p>
        ) : recommendations.length > 0 ? (
            ...
            >
              <div className="recommendation-card">
                ...
                <div className="recommendation-body">
                  ...
                  <p className="recommendation-id">#{item.article_id}</p>
                </div>
              </div>
            </Link>
          ))
